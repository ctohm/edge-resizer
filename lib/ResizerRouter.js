...
var require_withContent = __commonJS({
  "node_modules/itty-router-extras/middleware/withContent.js"(exports, module2) {
...
var require_withCookies = __commonJS({
  "node_modules/itty-router-extras/middleware/withCookies.js"(exports, module2) {
    var withCookies = (o) => {
      o.cookies = {};
      try {
...
var require_withParams = __commonJS({
  "node_modules/itty-router-extras/middleware/withParams.js"(exports, module2) {
    var withParams = (a) => {
...
var require_middleware = __commonJS({
  "node_modules/itty-router-extras/middleware/index.js"(exports, module2) {
...
var require_createResponseType = __commonJS({
  "node_modules/itty-router-extras/response/createResponseType.js"(exports, module2) {
...
var require_json = __commonJS({
  "node_modules/itty-router-extras/response/json.js"(exports, module2) {
...
var require_error = __commonJS({
  "node_modules/itty-router-extras/response/error.js"(exports, module2) {
...
var require_missing = __commonJS({
  "node_modules/itty-router-extras/response/missing.js"(exports, module2) {
...
var require_status = __commonJS({
  "node_modules/itty-router-extras/response/status.js"(exports, module2) {
    var { json: json2 } = require_json();
...
var require_text = __commonJS({
  "node_modules/itty-router-extras/response/text.js"(exports, module2) {
...
var require_response = __commonJS({
  "node_modules/itty-router-extras/response/index.js"(exports, module2) {
...
var require_ThrowableRouter = __commonJS({
  "node_modules/itty-router-extras/router/ThrowableRouter.js"(exports, module2) {
    "use strict";
    ...
    module2.exports = { ThrowableRouter };
  }
});

// node_modules/itty-router-extras/router/index.js
var require_router = __commonJS({
  "node_modules/itty-router-extras/router/index.js"(exports, module2) {
...
var require_StatusError = __commonJS({
  "node_modules/itty-router-extras/classes/StatusError.js"(exports, module2) {
...
var require_classes = __commonJS({
  "node_modules/itty-router-extras/classes/index.js"(exports, module2) {
...
var require_itty_router_extras = __commonJS({
  "node_modules/itty-router-extras/index.js"(exports, module2) {
...
var ResizerRouter = class {
  constructor(options) {
    ...
    const validXFormKeys = Object.keys(AvailableTransforms).concat(Object.keys(FormatAliases), Object.keys(FitAliases), Object.keys(deviceHints), ["http", "https"]), validTransforms = Object.values(AvailableTransforms).map((tx) => tx.regex).concat(Object.values(deviceHints).map((hint) => hint.regex), Object.keys(FitAliases), Object.keys(FormatAliases), ["http", "https", "_"]).join("|");
    const transformationsGroupOld = `(?<transformations>(_?(${validXFormKeys.join("|")})?(=[^:_/]*)*)+)`, transformationsGroup = `(?<transformations>(${validTransforms})(([_,](${validTransforms}))*)+)`, originhostGroup = "(?<originhost>(self|([a-z0-9:@_-]+)(\\.[a-z0-9_-]+)(\\.[a-z0-9_-]+)?(\\:\\d+)?))", pathNameGroup = `(?<pathname>(.*))`;
    const groupRegex = `/${transformationsGroup}/(https?://)?${originhostGroup}/${pathNameGroup}`, domainlessRegex = `/${transformationsGroup}/(?<dummyhost>([a-z0-9_-][^/]*))/${pathNameGroup}`;
...
async function computeCachedResponse(imageRequest, ctx, debug) {
  ...
  const canonicalVariationURL = imageRequest.headers.get("x-er-canonical-variation-url"), fileName = imageRequest.headers.get("fileName"), sourceUrl = imageRequest.headers.get("x-er-source-url"), inputExtension = imageRequest.headers.get("x-er-input-extension") || fileName?.split(".").pop() || "", weserveUrlStr = imageRequest.url;
