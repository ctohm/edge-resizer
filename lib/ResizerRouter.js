...
// ResizerRouter.ts
var ResizerRouter_exports = {};
__export(ResizerRouter_exports, {
...
function getFileName(url) {
  const { pathname } = url, lastPart = (decodeURIComponent(pathname || "").split("?")[0] || "").replace(/\/$/, "").split("/").pop() || "";
...
var transformKey = Object.keys(AvailableTransforms).concat(Object.keys(FormatAliases), Object.keys(FitAliases), Object.keys(deviceHints), ["http", "https"]);
...
module.exports = __toCommonJS(ResizerRouter_exports);
